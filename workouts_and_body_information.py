...
Original file is located at
    https://colab.research.google.com/drive/1yt2gTAUWoPY58ihHvId1b-8CzXYOGqO3
"""
...
def calculate_body_fat_percentage(gender, waist, neck, height, hip=None):
    """Vücut yağ oranını hesaplar."""
    if gender.lower() == "male":
        # Erkekler için hesaplama formülü
        ...
        # Kadınlar için hesaplama formülü
        body_fat = 495 / (1.31179 - 0.35004 * math.log10(waist + hip - neck) + 0.22100 * math.log10(height)) - 450
    else:
...
def main():
    ...
    try:
        ...
        body_fat = calculate_body_fat_percentage(gender, waist, neck, height, hip)
